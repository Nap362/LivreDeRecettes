...
public class RecetteILU3 implements Iterable<String>{
	
	private enum Type {
		POISSON("Poisson"), VIANDE("Viande"), VEGE("Végératien"), DESSERT("Dessert");
	...
	public RecetteILU3(String nom, int temps, String type) {
		this.nom = nom; 
		this.temps = temps;
		if (type!=null) {
	...
	public void setListeIngredients(String ingredients) {
	...
	public String afficher(int personnes) {
		...
		affichage.append("\t" + nom + " :\n" + "Pour " + personnes + " personnes\n" + "Temps de réalisation : "
				+ afficherTemps() + "\n");
		affichage.append("Ingrédients :\n" /*TODO : + ingredients.afficherListePersonne(personnes)*/);
		affichage.append("\nRéalisation :\n" + afficherInstructions());
		return affichage.toString();
	}

//	public boolean recetteRealisable(ListeAliments placard) {
//		return false /*TODO : placard.tousIngredientsDisponibles(ingredients)*/;
//	}
//
//	public boolean recetteContientAuMoinsUnIngredient(String[] AlimentsRecherches) {
//		return false/*TODO : ingredients.contientAuMoinsUnIngredient(AlimentsRecherches)*/;
//	}
	
	@Override
	public boolean equals(Object obj) {
		if (obj instanceof RecetteILU3) {
			RecetteILU3 recette = (RecetteILU3) obj;
