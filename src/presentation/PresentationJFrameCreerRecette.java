...
public class PresentationJFrameCreerRecette extends JFrame {
	...
	public PresentationJFrameCreerRecette() {
		...
		cbxTypeViande.setModel(new DefaultComboBoxModel<>(new String[] { "Agneau", "Boeuf", "Canard", "Dinde", "Gibier",
				"Lapin", "Mouton", "Pintade", "Porc", "Poulet", "Veau" }));
		cbxTypeViande.setFont(new Font("Tahoma", Font.PLAIN, 14));

		cbxTypePoisson = new JComboBox<>();
		cbxTypePoisson.setModel(new DefaultComboBoxModel<>(
				new String[] { "Bar", "Cabillaud", "Dorade", "Eglefin", "Hareng", "Limande", "Maquereau", "Merlan",
						"Merlu", "Sar", "Saumon", "Sole", "Truite", "Turbot", "Crabe", "Crevette", "Ecrevisse",
						"Gambas", "Homard", "Langouste", "Langoustine", "Tourteau", "Bigorneau", "Bulot", "Clam",
						"Coque", "StJacques", "Couteau", "Huitre", "Moule", "Palourde", "Petoncle", "Telline" }));
		...
		btnCreer.setFont(new Font("Tahoma", Font.BOLD, 15));
		...
		cbxUnite.setModel(new DefaultComboBoxModel<>(
				new String[] { "g", "mg", "L", "cL", "mL", "pincee", "CAS", "CAC", "sachet", "sans" }));
		...
		glContentPane.setHorizontalGroup(glContentPane.createParallelGroup(Alignment.TRAILING).addGroup(glContentPane
				.createSequentialGroup().addGap(10)
				.addGroup(glContentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(glContentPane.createSequentialGroup().addGap(49).addComponent(lblNouvelleRecette,
								GroupLayout.PREFERRED_SIZE, 179, GroupLayout.PREFERRED_SIZE))
						.addGroup(glContentPane.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(glContentPane.createParallelGroup(Alignment.LEADING, false).addGroup(
										glContentPane.createSequentialGroup().addGap(17).addGroup(glContentPane
												.createParallelGroup(Alignment.TRAILING).addComponent(chckbxVegan)
												.addGroup(glContentPane.createParallelGroup(Alignment.TRAILING, false)
														.addGroup(glContentPane.createSequentialGroup()
																.addComponent(lblTypeViande)
																.addPreferredGap(ComponentPlacement.RELATED,
																		GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																.addComponent(cbxTypeViande, GroupLayout.PREFERRED_SIZE,
																		138, GroupLayout.PREFERRED_SIZE))
														.addGroup(glContentPane.createSequentialGroup()
																.addComponent(lblTypePoisson).addGap(18).addComponent(
																		cbxTypePoisson, GroupLayout.PREFERRED_SIZE, 138,
																		GroupLayout.PREFERRED_SIZE)))))
										.addGroup(glContentPane.createSequentialGroup()
												.addComponent(lblType, GroupLayout.PREFERRED_SIZE, 106,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
														Short.MAX_VALUE)
												.addComponent(cbxType, GroupLayout.PREFERRED_SIZE, 164,
														GroupLayout.PREFERRED_SIZE))))
						.addGroup(glContentPane.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED)
								.addComponent(lblNom).addGap(10)
								.addComponent(txtfNom, GroupLayout.PREFERRED_SIZE, 235, GroupLayout.PREFERRED_SIZE))
						.addGroup(glContentPane.createSequentialGroup().addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(glContentPane.createParallelGroup(Alignment.LEADING).addComponent(lblTemps)
										.addComponent(lblNbrPersonnes))
								.addGap(74)
								.addGroup(glContentPane.createParallelGroup(Alignment.LEADING, false)
										.addComponent(spnPersonnes, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(spnTemps, GroupLayout.DEFAULT_SIZE, 62, Short.MAX_VALUE))))
				.addGroup(glContentPane.createParallelGroup(Alignment.LEADING).addGroup(glContentPane
						...
						.addGroup(glContentPane.createParallelGroup(Alignment.TRAILING)
								.addGroup(glContentPane.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(glContentPane.createSequentialGroup()
												.addComponent(txtfNomIngredient, GroupLayout.PREFERRED_SIZE, 186,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addComponent(txtfQuantite, GroupLayout.PREFERRED_SIZE, 53,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.UNRELATED)
						...
						.addGroup(Alignment.TRAILING,
								glContentPane.createSequentialGroup().addGap(238).addComponent(btnAjouterInstruction)))
				.addGap(20))
				.addGroup(Alignment.LEADING,
						glContentPane.createSequentialGroup().addGap(294)
								.addGroup(glContentPane.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(btnAnnuler, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
												GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(btnCreer, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 128,
												GroupLayout.PREFERRED_SIZE))
								.addContainerGap(295, Short.MAX_VALUE)));
		glContentPane.setVerticalGroup(glContentPane.createParallelGroup(Alignment.LEADING).addGroup(glContentPane
				.createSequentialGroup().addGap(27).addComponent(lblNouvelleRecette).addGap(18)
				.addGroup(glContentPane.createParallelGroup(Alignment.LEADING, false).addGroup(glContentPane
						.createSequentialGroup()
						.addGroup(glContentPane.createParallelGroup(Alignment.BASELINE)
								.addComponent(cbxType, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblType))
						.addPreferredGap(ComponentPlacement.RELATED)
						.addGroup(glContentPane.createParallelGroup(Alignment.BASELINE)
								.addComponent(cbxTypeViande, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblTypeViande))
						.addGap(6)
						.addGroup(glContentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(glContentPane.createSequentialGroup().addGap(3).addComponent(lblTypePoisson))
								.addGroup(glContentPane.createSequentialGroup()
										.addComponent(cbxTypePoisson, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGap(6).addComponent(chckbxVegan)))
						.addGap(18)
						.addGroup(glContentPane.createParallelGroup(Alignment.BASELINE)
								.addComponent(txtfNom, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lblNom)))
						.addGroup(glContentPane.createSequentialGroup()
								.addComponent(
										txtIngredients, GroupLayout.PREFERRED_SIZE, 76, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(glContentPane.createParallelGroup(Alignment.BASELINE)
										.addComponent(cbxUnite, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(txtfNomIngredient, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addComponent(txtfQuantite, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(btnAjouterIngredient).addGap(14)))
				.addGroup(glContentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(glContentPane.createSequentialGroup().addGap(4)
								.addComponent(txtInstructions, GroupLayout.PREFERRED_SIZE, 76,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(txtfInstruction,
										GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE))
						.addGroup(glContentPane.createSequentialGroup().addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(glContentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblTemps)
										.addComponent(spnTemps, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addGroup(glContentPane.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblNbrPersonnes).addComponent(spnPersonnes,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))))
				.addPreferredGap(ComponentPlacement.RELATED)
				.addComponent(btnAjouterInstruction, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(ComponentPlacement.RELATED, 19, Short.MAX_VALUE).addComponent(btnCreer)
				.addPreferredGap(ComponentPlacement.RELATED)
	...
	public void enableValidationInformation(String nom) {
		JOptionPane.showConfirmDialog(this, "Recette " + nom + " ajoutée à votre livre de recettes.",
				"Opération réussie", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE);
	}
